window.addEventListener("DOMContentLoaded", () => {
  ...
  var typingImage = document.querySelector(".typing-pixelated");
  if (typingImage) {
    typingImage.addEventListener("mouseenter", function () {
      typingImage.src = "images/Typing Pixelated 3.gif"; 
    });

    typingImage.addEventListener("mouseleave", function () {
      typingImage.src = "images/Typing Pixelated 2.gif"; 
    });
  }
  ...
  if (ctaButton) {
    ctaButton.addEventListener("click", function (event) {
      playSoundAndNavigate(event, "projects.html");
    });
  }
